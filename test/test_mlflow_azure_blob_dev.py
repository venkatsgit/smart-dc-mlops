...
def simple_artifact_test():
    ...
    tracking_uri = "http://4.144.173.96/mlflowdev/"
    mlflow.set_tracking_uri(tracking_uri)
    
    # Set authentication credentials
    os.environ['MLFLOW_TRACKING_USERNAME'] = 'mlops'
    os.environ['MLFLOW_TRACKING_PASSWORD'] = 'mlopsuser'
    ...
    try:
        ...
        with mlflow.start_run(run_name=run_name):
            ...
            print(f"View run at: http://4.144.173.96/mlflowdev/#/experiments/{experiment_id}/runs/{run_id}")
